...
public interface IImportedWindowsAutopilotDeviceIdentityCollectionRequestBuilder extends IRequestBuilder {
    ...
    IImportedWindowsAutopilotDeviceIdentityCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions);

    IImportedWindowsAutopilotDeviceIdentityRequestBuilder byId(final String id);


    IImportedWindowsAutopilotDeviceIdentityImportCollectionRequestBuilder importList(final java.util.List<ImportedWindowsAutopilotDeviceIdentity> importedWindowsAutopilotDeviceIdentities);
}
